...
__2) Perform K-means clustering with number of clusters as 4 and 5__
...
As observed, PCA 1 and PCA 2 combined explain majority of the data variance and then there is a drop from PCA 2 to PCA 3. Hence this infers that, visualization with PCA 1 and PC 2 will give a good understanding of the data and including more PCA's after PCA 2 will only result in a minimal improvement.

...
train_predicted <- predict(knnFit, train_ds, type = "class")
  print("Evaluation for the training")
  get_evaluation(as.factor(y_train), train_predicted, "y")
  predicted <- predict(knnFit, test_ds, type = "class")
  print("Evaluation for the tests")
  get_evaluation(as.factor(y_test), predicted, "y")
  draw_plot_for_classes(test_ds, predicted, "knn clsf test")

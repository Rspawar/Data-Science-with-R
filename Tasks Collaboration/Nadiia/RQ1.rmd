...
knnFit <- knn3(train_ds, y_train, k = 39)
classify_with_fit(knnFit, "KNN classification")
```

### Classification with SVM
First and foremost when it’s a two class classification problem and the no of features is less, svm works better than other algorithms
```{r echo=TRUE, message=FALSE}
#tune SVM
